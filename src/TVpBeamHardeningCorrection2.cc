...
#include <cmath>
#include <iostream>
#include "TVpBeamHardeningCorrection2.h"
#include "TVpMath.h"

ClassImp(TVpBeamHardeningCorrection2)

//______________________________________________________________________________
TVpBeamHardeningCorrection2::TVpBeamHardeningCorrection2(TVpMaterial *materialPtr,
...
//______________________________________________________________________________
TVpBeamHardeningCorrection2::~TVpBeamHardeningCorrection2()
{
  // Destructor.
...
//______________________________________________________________________________
void TVpBeamHardeningCorrection2::SetEffectiveLac(Double_t effLac)
{
...
//______________________________________________________________________________
Double_t TVpBeamHardeningCorrection2::GetGridP(Double_t x) const
{
  ...
  if (il < 0 || il > fDim-2)
    {
      std::cerr << "Error: TVpBeamHardeningCorrection2::GetGridP: x = "
...
//______________________________________________________________________________
Double_t TVpBeamHardeningCorrection2::GetGridX(Double_t P) const
{
  // Return P for an x.  Use lin-lin interpolation
  //
  // Input parameters:
  ...
  if (il < 0)
    {
      std::cerr << "Error: TVpBeamHardeningCorrection2::GetGridX: P = "
...
//______________________________________________________________________________
Double_t TVpBeamHardeningCorrection2::CalculateP(Double_t x) const
{
...
//______________________________________________________________________________
Double_t TVpBeamHardeningCorrection2::CalculateS() const
{
...
//______________________________________________________________________________
Double_t TVpBeamHardeningCorrection2::GetI0(Double_t distance) const
{
...
//______________________________________________________________________________
Double_t TVpBeamHardeningCorrection2::Correct(Double_t I1overI0) const
{
  // Correct
...
//______________________________________________________________________________
Double_t TVpBeamHardeningCorrection2::Correct(Double_t I2overI1, Double_t I1overI0) const
{
  // Correct
...
//______________________________________________________________________________
Double_t TVpBeamHardeningCorrection2::Correct(Double_t I2, Double_t I1, Double_t I0) const
{
  // Correct
...
//______________________________________________________________________________
TGraph *TVpBeamHardeningCorrection2::GetGraphGridP() const
{
...
//______________________________________________________________________________
TGraph *TVpBeamHardeningCorrection2::GetGraphMonoP() const
{
